...
def encode_queries_in_batches(queries:pd.Series,model_name="sentence-transformers/all-MiniLM-L6-v2",batch_size:int=32):
...
def build_features_from_pairs(pairs_df:pd.DataFrame,
    ...
    print(f"Encoding {len(unique_queries)} queries in batches (batch_size={batch_size})")
